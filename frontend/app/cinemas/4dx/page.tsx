...
export default function FourDXPage() {
  const fourDXCinemas = [
    {
      id: 1,
      name: '4DX Experience Mumbai',
      location: 'Bandra, Western Mumbai',
      screens: 1,
      rating: 4.8,
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="mb-12">
            ...
            <h1 className="text-4xl font-bold tracking-tight mb-4">4DX Cinemas</h1>
            <p className="text-lg text-muted-foreground max-w-3xl">
              Feel every moment with 4DX technology. Motion seats, dynamic lighting, and environmental effects
              create an immersive cinematic experience like no other.
            </p>
          </div>

          <div className="space-y-6">
            {fourDXCinemas.map((cinema) => (
              <div
                key={cinema.id}
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex items-center gap-6 text-sm">
                      <div>
                        ...
                        <span className="text-muted-foreground ml-1">4DX Screen</span>
                      </div>
